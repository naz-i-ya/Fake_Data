...
import {options,dataTemplate} from "./data/options.js";
...
copyData = JSON.parse(JSON.stringify(options));
  ...
  download(JASON.stringify(arrData),"fake_data.js","json");
setNumberOfData(1);
...
<TextField fullWidth variant ="outlined"  Lable="enter the number of fake data"
